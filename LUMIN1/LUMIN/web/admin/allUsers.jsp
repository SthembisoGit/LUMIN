<%@ page import="java.sql.*, lumin.model.DBConnection" %>
...
<body>
    ...
    <%
        try (Connection conn = DBConnection.getConnection()) {
            String sql = "SELECT UserID, FullName, Email, Role, Status, CreatedAt, RegNumber, selfieimage FROM Users";
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                %>
                                    <img src="data:image/jpeg;base64,<%= base64Image %>" alt="Selfie with ID" width="100"/>
                <%
                                } else {
                                    out.print("No image");
                                }
    ...
    <br>
    <a href="pendingUsers.jsp">Go to Pending Users</a> | 
